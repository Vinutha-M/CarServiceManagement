...
<body id="body">
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container clearfix">
      <div class="contact-info float-left">
        <i class="fa fa-envelope-o"></i> <a href="mailto:contact@example.com">carservice@gmail.com</a>
  ...
  <section id="intro">
    ...
    <div class="intro-content">
      ...
      <div>
        <a href="profile.php" class="btn-get-started scrollto">Booking Service</a>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInLeft" data-wow-delay="0.2s">
              ...
              <h4 class="title"><a href="">GENERAL SERVICE</a></h4>
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInRight" data-wow-delay="0.2s">
              ...
              <h4 class="title"><a href="">BASIC SERVICE</a></h4>
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>carservice</strong>. All Rights Reserved
      </div>
      <div class="credits">
